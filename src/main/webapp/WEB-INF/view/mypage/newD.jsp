...
<body>
	...
	<form action="deliveryList" method="POST" name="f">
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<div class="mb-1">
					...
					<input type="text" class="form-control" id="delivery_phoneNo" name="delivery_phoneNo">
				</div>
			</div>
		</div>
		<button class="btn btn-danger" type="button" id="newDBtn">배송지 추가</button>		
	</form>
	</div>
</body>
</html>